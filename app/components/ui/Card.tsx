  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-programe-elements-borderColor bg-programe-elements-background-depth-1 text-programe-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-programe-elements-textSecondary', className)} {...props} />;
  },
);
