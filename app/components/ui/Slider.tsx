...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-programe-elements-background-depth-1 overflow-hidden rounded-full p-1">
    ...
    <button
      ...
      className={classNames(
        ...
        selected
          ...
          : 'text-programe-elements-item-contentDefault hover:text-programe-elements-item-contentActive',
      )}
    >
      ...
      {selected && (
        <motion.span
          ...
          className="absolute inset-0 z-0 bg-programe-elements-item-backgroundAccent rounded-full"
        ></motion.span>
      )}
    </button>
  );
