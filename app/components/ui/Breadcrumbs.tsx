      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-programe-elements-textPrimary dark:text-programe-elements-textPrimary-dark'
              : 'text-programe-elements-textSecondary dark:text-programe-elements-textSecondary-dark hover:text-programe-elements-textPrimary dark:hover:text-programe-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-programe-elements-textTertiary dark:text-programe-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
