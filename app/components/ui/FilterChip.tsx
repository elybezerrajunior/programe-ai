    ...
    <motion.div
      ...
      className={classNames(
        ...
        active
          ...
          : 'bg-programe-elements-background-depth-2 dark:bg-programe-elements-background-depth-3 text-programe-elements-textSecondary dark:text-programe-elements-textSecondary-dark border border-programe-elements-borderColor dark:border-programe-elements-borderColor-dark',
        onRemove && 'pr-1',
        className,
      )}
    >
      ...
      {onRemove && (
        <button
          ...
          onClick={onRemove}
          className={classNames(
            'ml-1 p-0.5 rounded-full hover:bg-programe-elements-background-depth-3 dark:hover:bg-programe-elements-background-depth-4 transition-colors',
            active
