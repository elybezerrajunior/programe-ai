...
export function SupabaseConnection({ hideTrigger = false }: SupabaseConnectionProps) {
  const {
  ...
  return (
    <div className="relative">
      {!hideTrigger && (
        <div className="flex border border-programe-elements-borderColor rounded-md overflow-hidden mr-2 text-sm">
          <Button
            active
            disabled={connecting}
            onClick={() => setIsDialogOpen(!isDialogOpen)}
            className="hover:bg-programe-elements-item-backgroundActive !text-white flex items-center gap-2"
          >
            <img
              className="w-4 h-4"
              height="20"
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <button
                        ...
                        className="bg-transparent text-left text-sm font-medium text-programe-elements-textPrimary flex items-center gap-2"
                      >
  ...
  return (
    <button
      className={classNames(
        ...
        {
          'bg-programe-elements-item-backgroundDefault hover:bg-programe-elements-item-backgroundActive text-programe-elements-textTertiary hover:text-programe-elements-textPrimary':
            !active,
          'bg-programe-elements-item-backgroundDefault text-programe-elements-item-contentAccent': active && !disabled,
          'bg-programe-elements-item-backgroundDefault text-alpha-gray-20 dark:text-alpha-white-20 cursor-not-allowed':
            disabled,
        },
        className,
      )}
