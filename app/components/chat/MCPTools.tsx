  ...
  return (
    <div className="relative">
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            <div className="i-svg-spinners:90-ring-with-bg text-programe-elements-loader-progress text-xl animate-spin"></div>
          ) : (
            <div className="i-programe:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-programe-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-programe-elements-icon-error">{error}</p>}</div>
              </div>
