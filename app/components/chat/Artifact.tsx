...
export const Artifact = memo(({ artifactId }: ArtifactProps) => {
  ...
  return (
    <>
      <div className="artifact border border-programe-elements-borderColor flex flex-col overflow-hidden rounded-lg w-full transition-border duration-150">
        <div className="flex">
          <button
            className="flex items-stretch bg-programe-elements-artifacts-background hover:bg-programe-elements-artifacts-backgroundHover w-full overflow-hidden"
            onClick={() => {
          ...
          {artifact.type !== 'bundled' && <div className="bg-programe-elements-artifacts-borderColor w-[1px]" />}
          <AnimatePresence>
        ...
        {artifact.type === 'bundled' && (
          <div className="flex items-center gap-1.5 p-5 bg-programe-elements-actions-background border-t border-programe-elements-artifacts-borderColor">
...
function getIconColor(status: ActionState['status']) {
  switch (status) {
    case 'pending': {
      return 'text-programe-elements-textTertiary';
    }
    case 'running': {
      return 'text-programe-elements-loader-progress';
    }
    case 'complete': {
      return 'text-programe-elements-icon-success';
    }
    case 'aborted': {
      return 'text-programe-elements-textSecondary';
    }
    case 'failed': {
      return 'text-programe-elements-icon-error';
    }
    default: {
      return undefined;
    }
