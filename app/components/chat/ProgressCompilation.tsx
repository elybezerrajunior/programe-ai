      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-programe-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-programe-elements-item-backgroundAccent hover:bg-programe-elements-artifacts-backgroundHover"
