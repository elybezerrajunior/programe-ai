      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-programe-elements-item-backgroundActive text-programe-elements-textSecondary hover:text-[#000000] z-50"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            className="px-3 py-2 rounded bg-programe-elements-background-depth-3 text-programe-elements-textPrimary text-xs z-50"
            sideOffset={5}
          >
            {deploymentUrl}
            <Tooltip.Arrow className="fill-programe-elements-background-depth-3" />
          </Tooltip.Content>
        </Tooltip.Portal>
      </Tooltip.Root>
    </Tooltip.Provider>
