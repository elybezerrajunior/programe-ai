...
import { detectProjectCommands, createCommandsMessage, escapeProgrameTags } from '~/utils/projectCommands';
...
${escapeProgrameTags(file.content)}
</boltAction>`,
  )
  .join('\n')}
</boltArtifact>`,
    ...
    <>
      <Button
        ...
        className={classNames(
          'gap-2 bg-programe-elements-background-depth-1',
      ...
      {isDialogOpen && !selectedProvider && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-programe-elements-borderColor dark:border-programe-elements-borderColor max-w-md w-full">
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-programe-elements-textPrimary dark:text-programe-elements-textPrimary">
                  Choose Repository Provider
                </h3>
                <button
                  onClick={() => setIsDialogOpen(false)}
                  className="p-2 rounded-lg bg-transparent hover:bg-programe-elements-background-depth-1 dark:hover:bg-programe-elements-background-depth-1 text-programe-elements-textSecondary dark:text-programe-elements-textSecondary hover:text-programe-elements-textPrimary dark:hover:text-programe-elements-textPrimary transition-all duration-200 hover:scale-105 active:scale-95"
                >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full p-4 rounded-lg bg-programe-elements-background-depth-1 dark:bg-programe-elements-background-depth-1 hover:bg-programe-elements-background-depth-2 dark:hover:bg-programe-elements-background-depth-2 border border-programe-elements-borderColor dark:border-programe-elements-borderColor hover:border-programe-elements-borderColorActive dark:hover:border-programe-elements-borderColorActive transition-all duration-200 text-left group"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-programe-elements-textPrimary dark:text-programe-elements-textPrimary">
                        GitHub
                      </div>
                      <div className="text-sm text-programe-elements-textSecondary dark:text-programe-elements-textSecondary">
      ...
      {isDialogOpen && selectedProvider === 'github' && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-programe-elements-borderColor dark:border-programe-elements-borderColor w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b border-programe-elements-borderColor dark:border-programe-elements-borderColor flex items-center justify-between">
              <div className="flex items-center gap-3">
