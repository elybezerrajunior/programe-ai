...
// Create a custom hook to connect to the programeHistory database
...
export function DataTab() {
  // Use our custom hook for the programeHistory database
  const { db, isLoading: dbLoading } = useProgrameHistoryDB();
  ...
  // Data operations hook with programeHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the programeHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      console.log('Loading chats from programeHistory database', {
        name: db.name,
        version: db.version,
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Chats Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-programe-elements-textPrimary">Conversas</h2>
        {dbLoading ? (
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center mb-2">
                  ...
                  <CardTitle className="text-lg group-hover:text-programe-elements-item-contentAccent transition-colors">
                ...
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    className={classNames(
                      'hover:text-programe-elements-item-contentAccent hover:border-programe-elements-item-backgroundAccent hover:bg-programe-elements-item-backgroundAccent transition-colors w-full justify-center',
      ...
      {/* Settings Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-programe-elements-textPrimary">Configurações</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* API Keys Section */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-programe-elements-textPrimary">Chaves de API</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <div className="flex items-center mb-2">
      ...
      {/* Data Visualization */}
      <div>
        <h2 className="text-xl font-semibold mb-4 text-programe-elements-textPrimary">Uso de Dados</h2>
        <Card>
