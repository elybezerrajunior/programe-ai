      ...
      <div className="p-6 space-y-6">
        {!isConnected ? (
          <div className="space-y-4">
            {environmentVariable && (
              <div className="text-xs text-programe-elements-textSecondary bg-programe-elements-background-depth-1 dark:bg-programe-elements-background-depth-1 p-3 rounded-lg mb-4">
                <p className="flex items-center gap-1 mb-1">
                  <span className="i-ph:lightbulb w-3.5 h-3.5 text-programe-elements-icon-success dark:text-programe-elements-icon-success" />
                  <span className="font-medium">Tip:</span> You can also set the{' '}
                  <code className="px-1 py-0.5 bg-programe-elements-background-depth-2 dark:bg-programe-elements-background-depth-2 rounded">
                    {environmentVariable}
                  </code>{' '}
            ...
            <form onSubmit={onConnect} className="space-y-4">
              {tokenTypes && tokenTypes.length > 1 && onTokenTypeChange && (
                <div>
                  ...
                  {selectedTokenType && tokenTypes.find((t) => t.value === selectedTokenType)?.description && (
                    <p className="mt-1 text-xs text-programe-elements-textTertiary">
              ...
              <div>
                <label className="block text-sm text-programe-elements-textSecondary mb-2">{tokenLabel}</label>
                <input
                  type="password"
                  value={token}
