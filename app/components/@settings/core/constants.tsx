...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  github: 'Conecte e gerencie a integração com GitHub',
  gitlab: 'Conecte e gerencie a integração com GitLab',
  netlify: 'Configure as configurações de implantação do Netlify',
  vercel: 'Gerencie projetos e implantações do Vercel',
  supabase: 'Configure a conexão com o banco de dados Supabase',
  'event-logs': 'Visualize eventos e logs do sistema',
  mcp: 'Configure servidores MCP (Model Context Protocol)',
};
