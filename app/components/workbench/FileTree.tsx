...
function ContextMenuItem({ onSelect, children }: { onSelect?: () => void; children: ReactNode }) {
  return (
    <ContextMenu.Item
      onSelect={onSelect}
      className="flex items-center gap-2 px-2 py-1.5 outline-0 text-sm text-programe-elements-textPrimary cursor-pointer ws-nowrap text-programe-elements-item-contentDefault hover:text-programe-elements-item-contentActive hover:bg-programe-elements-item-backgroundActive rounded-md"
    >
...
function InlineInput({ depth, placeholder, initialValue = '', onSubmit, onCancel }: InlineInputProps) {
  ...
  return (
    <div
      className="flex items-center w-full px-2 bg-programe-elements-background-depth-4 border border-programe-elements-item-contentAccent py-0.5 text-programe-elements-textPrimary"
      style={{ paddingLeft: `${6 + depth * NODE_PADDING_LEFT}px` }}
    >
      <div className="scale-120 shrink-0 i-ph:file-plus text-programe-elements-textTertiary" />
      <input
        ref={inputRef}
        type="text"
        className="ml-2 flex-1 bg-transparent border-none outline-none py-0.5 text-sm text-programe-elements-textPrimary placeholder:text-programe-elements-textTertiary min-w-0"
    ...
    <>
      <ContextMenu.Root>
        <ContextMenu.Trigger>
          <div
            ...
            className={classNames('relative', {
              'bg-programe-elements-background-depth-2 border border-dashed border-programe-elements-item-contentAccent rounded-md':
                isDragging,
            })}
          >
            {children}
        ...
        <ContextMenu.Portal>
          <ContextMenu.Content
            style={{ zIndex: 998 }}
            className="border border-programe-elements-borderColor rounded-md z-context-menu bg-programe-elements-background-depth-1 dark:bg-programe-elements-background-depth-2 data-[state=open]:animate-in animate-duration-100 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-98 w-56"
          >
            <ContextMenu.Group className="p-1 border-b-px border-solid border-programe-elements-borderColor">
            ...
            <ContextMenu.Group className="p-1 border-t-px border-solid border-programe-elements-borderColor">
              {!isFolder ? (
                <>
    ...
    <FileContextMenu onCopyPath={onCopyPath} onCopyRelativePath={onCopyRelativePath} fullPath={folder.fullPath}>
      <NodeButton
        className={classNames('group', {
          'bg-transparent text-programe-elements-item-contentDefault hover:text-programe-elements-item-contentActive hover:bg-programe-elements-item-backgroundActive':
            !selected,
          'bg-programe-elements-item-backgroundAccent text-programe-elements-item-contentAccent': selected,
        })}
        depth={folder.depth}
...
function File({
  ...
  return (
    <FileContextMenu onCopyPath={onCopyPath} onCopyRelativePath={onCopyRelativePath} fullPath={fullPath}>
      <NodeButton
        className={classNames('group', {
          'bg-transparent hover:bg-programe-elements-item-backgroundActive text-programe-elements-item-contentDefault':
            !selected,
          'bg-programe-elements-item-backgroundAccent text-programe-elements-item-contentAccent': selected,
        })}
        depth={depth}
        iconClasses={classNames('i-ph:file-duotone scale-98', {
          'group-hover:text-programe-elements-item-contentActive': !selected,
        })}
        onClick={onClick}
      >
        <div
