  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-programe-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-programe-elements-background-depth-2 border-y border-programe-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-programe-elements-terminals-buttonBackground text-programe-elements-textSecondary hover:text-programe-elements-textPrimary':
                            isActive,
                          'bg-programe-elements-background-depth-2 text-programe-elements-textSecondary hover:bg-programe-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-programe-elements-terminals-buttonBackground text-programe-elements-textPrimary': isActive,
                            'bg-programe-elements-background-depth-2 text-programe-elements-textSecondary hover:bg-programe-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-programe-elements-textTertiary hover:text-programe-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachProgrameTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachProgrameTerminal(terminal)}
