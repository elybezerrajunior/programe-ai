...
export function LoginForm() {
  ...
  const loaderData = useLoaderData<typeof import('~/routes/login').loader>();
      ...
      {errorMessage && (
        <div className="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20 animate-in fade-in slide-in-from-top-2">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-red-500 mb-1">Erro ao fazer login</p>
      ...
      <Form method="post" className="flex flex-col gap-6">
        ...
        <div className="flex flex-row gap-3">
          ...
          >
            {oauthLoading === 'google' ? (
              <>
                <span className="i-svg-spinners:90-ring-with-bg text-base animate-spin" />
