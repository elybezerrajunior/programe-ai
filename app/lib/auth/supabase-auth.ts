 ...
 * @param env - Variáveis de ambiente do Cloudflare (opcional, necessário em produção)
 */
export async function signInWithPassword(email: string, password: string, env?: CloudflareEnv) {
